...
public class Connection {
	...
	// function to create new connection if does not exist and #connections still less than 3
	public static Connection CreateConnection(Connection connection , String protocol) {
		...
		if(connection == null) {
		   ...
		   } else System.out.println("Sorry, You Can't Create More Than 3 Conncetions!");
